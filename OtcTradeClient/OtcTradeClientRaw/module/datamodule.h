...
public:
    ...
    virtual     int         GetOneName(tagXTInstrument& oExCode, char* poutname) =0;
    virtual     int         GetAllCodeList(std::vector<tagXTInstrument>& arr) = 0;
    virtual     int         GetAllNameTableList(std::vector<tagXTNameTable>& arr) = 0;
};
