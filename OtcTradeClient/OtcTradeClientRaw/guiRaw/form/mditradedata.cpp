...
//============================================================================================================================================================================================================================
CMDITradeData::CMDITradeData(QWidget *parent) :
    QWidget(parent)
{
...
CMDITradeData::~CMDITradeData()
{

}

void    CMDITradeData::initControls()
{
    //[0]
    _label = new QLabel();
...
void CMDITradeData::closeEvent(QCloseEvent *event)
{
...
void   CMDITradeData::on_combox_indexChange(int)
{
...
void   CMDITradeData::onTransactEvent(TransactionEventArgs* e)
{
    qDebug() << "CMDITradeData" << "onTransactEvent";
