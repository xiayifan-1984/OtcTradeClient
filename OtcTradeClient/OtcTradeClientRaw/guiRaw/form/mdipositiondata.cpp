...
//============================================================================================================================================================================================================================
CMDIPositionData::CMDIPositionData(QWidget *parent) :
	QWidget(parent)
{
...
CMDIPositionData::~CMDIPositionData()
{

}

void    CMDIPositionData::initControls()
{
	//[0]
	_label = new QLabel();
...
void CMDIPositionData::closeEvent(QCloseEvent *event)
{
...
void   CMDIPositionData::on_combox_indexChange(int)
{
...
void   CMDIPositionData::onTransactEvent(TransactionEventArgs* e)
{
    qDebug() << "CMDIPositionData" << "onTransactEvent";
